...
<html lang="en">
<head>
    <title>Code coverage report for enzyme/src/ReactWrapper.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">enzyme/src</a> ReactWrapper.js
    </h1>
    <div class='clearfix'>
...
701
702
703</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  constructor(nodes, root, options = {}) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!global.window &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >!g</span>lobal.document) {
...
&nbsp;
   ...
   */
  ref(refname) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.root !== this) {
...
&nbsp;
   ...
   */
  update() {
<span class="cstat-no" title="statement not covered" ></span>    if (this.root !== this) {
...
<span class="cstat-no" title="statement not covered" >    this.single(<span class="fstat-no" title="function not covered" >() =&gt; {</span></span>
<span class="cstat-no" title="statement not covered" >      this.component.forceUpdate();</span>
    });
...
&nbsp;
   ...
   */
  props() {
    return this.single(n =&gt; g</span>etNode(n).props || <span class="branch-1 cbranch-no" title="branch not covered" >{});
  }
&nbsp;
  /**
...
&nbsp;
   ...
   */
  hasClass(className) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (className &amp;&amp; className.indexOf('.') !== -1) {
...
&nbsp;
   ...
   */
  single(fn) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.length !== 1) {
<span class="cstat-no" title="statement not covered" >      throw new Error(</span>
...
&nbsp;
   ...
   */
  wrap(node) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (node instanceof ReactWrapper) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Feb 02 2016 10:59:05 GMT-0800 (PST)
</div>
</div>
