(function() {
  'use strict';
  var Document = require('../../../../app/scripts/components/Documents/Document.jsx'),
  ...
  describe('Document', function() {
    // beforeEach(function() {
    //   sinon.stub(Document.prototype, 'docId').returns(true);
    // });
    var doc = [{
    ...
    //   var document = enzyme.shallow(<Document documents = {doc} />);
